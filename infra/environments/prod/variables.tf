###############################################################################
# prod — variable declarations
###############################################################################

variable "subscription_id" {
  description = "Azure subscription ID where prod resources are deployed."
  type        = string
  sensitive   = true
}
...
variable "owner" {
  description = "Team or individual responsible for the prod environment."
  type        = string
  default     = ""
}
