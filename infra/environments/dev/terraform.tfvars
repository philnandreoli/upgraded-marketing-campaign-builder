...
# ---------------------------------------------------------------------------
# Copy sensitive values to a local terraform.tfvars.local file (gitignored)
# and reference them via -var-file or environment variables.
# ---------------------------------------------------------------------------
...
# Networking — public access for dev
enable_private_networking               = false
vnet_address_space                      = ["10.0.0.0/16"]
container_apps_subnet_address_prefix    = "10.0.0.0/23"
postgresql_subnet_address_prefix        = "10.0.2.0/27"
private_endpoints_subnet_address_prefix = "10.0.2.32/27"
...
# Key Vault — no purge protection for dev
key_vault_soft_delete_retention_days = 7
key_vault_purge_protection_enabled   = false

# Service Bus — Standard for dev
...
# PostgreSQL — small SKU for dev, password auth enabled
...
# Container Apps — Consumption profile, small sizing
