...
def get_executor() -> WorkflowExecutor:
    ...
    if executor_type == "in_process":
        from backend.infrastructure.executors.in_process import InProcessExecutor  # noqa: PLC0415

        return InProcessExecutor()

    if executor_type == "azure_service_bus":
        from backend.infrastructure.executors.azure_service_bus import AzureServiceBusExecutor  # noqa: PLC0415
